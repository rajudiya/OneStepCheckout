 ...
 */
namespace Seofeb\OneStepCheckout\Block\Checkout;
...
use Seofeb\OneStepCheckout\Helper\AddressFields as AddressFieldsHelper;
...
class OneStepCheckoutProcessor implements LayoutProcessorInterface
{
    ...
    public function getCustomBillingAddressComponent($elements)
    {
        ...
        $fields = [
            'component' => 'Seofeb_OneStepCheckout/js/view/billing-address',
