...
class Icons extends \Magento\Framework\View\Element\Html\Select
{
    /**
     * @param string $value
     * @return $this
    ...
    public function _toHtml()
    {
        if (!$this->getOptions()) {
            ...
            foreach ($this->getFontIcons() as $code => $content) {
                $this->addOption($content, addslashes($code));
            }
    ...
    protected function _optionToHtml($option, $selected = false)
    {
        ...
        return sprintf(
            '<option class="fa %s" value="%s"%s %s>%s</option>',
    ...
    protected function getFontIcons()
    {
        return [
            'fa-glass'                               => 'f000',
            'fa-music'                               => 'f001',
