<?php
namespace Seofeb\OrderComment\Test\Unit\Model;
...
{
    /**
     * @var \Seofeb\OrderComment\Model\GuestOrderCommentManagement
     */
    ...
    protected function setUp()
    {
        ...
        $this->orderCommentManagementMock = $this->getMock(
            'Seofeb\OrderComment\Model\OrderCommentManagement',
            [],
            [],
            '',
            false
        ...
        $this->testObject = $objectManager->getObject(
            'Seofeb\OrderComment\Model\GuestOrderCommentManagement',
            [
    ...
    public function testSaveComment()
    {
        ...
        $orderCommentMock = $this->getMockBuilder('\Seofeb\OrderComment\Model\Data\OrderComment')
